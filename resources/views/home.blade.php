{{--@dd($member->policies[0])--}}
                 <x-master>
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-4">
                                         <div class="stat-card stat-card-success">
                                             ...
                                             <p class="card-value">{{ number_format($totalVets) }}</p>
                                         </div>
                                     </div>
                                     <div class="col-md-4">
                                         <div class="stat-card stat-card-info">
                                             ...
                                             <p class="card-value">{{ number_format($totalFarmers) }}</p>
                                         </div>
                                     </div>
                                 </div>
                                         ...
                                         <div class="row g-3">
                                             <div class="col-md-6">
                                                 <div class="chart-card">
                                                     <div class="card-body">
                                                         <h6 class="card-title">🦠 Most Common Diseases Diagnosed</h6>
                                             ...
                                             <div class="col-md-6">
                                                 <div class="chart-card">
                                                     <div class="card-body">
                                                         <h6 class="card-title">🐑 Livestock Distribution by Species</h6>
                                             ...
                                             <div class="col-md-8">
                                                 <div class="chart-card">
                                                     <div class="card-body">
                                                         <h6 class="card-title">📈 Livestock Registrations Over Time</h6>
                                             ...
                                             <div class="col-md-4">
                                                 <div class="row g-3">
                                                     ...
                                                     <div class="col-12">
                                                         <div class="info-card">
                                                             <h6>⚠️ Active Disease Alerts</h6>
                                                             <div class="metric">{{ number_format($activeAlerts) }}</div>
                                                             <div class="sub-metric">
                                                                 Missed vaccinations: <strong>{{ number_format($missedVaccinations) }}</strong>
                                                             </div>
                                                         </div>
                                                     </div>
                                                 </div>
                     ...
                     <script>
                         ...
                         // Livestock distribution doughnut
