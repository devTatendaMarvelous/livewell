...
function layout_theme_contrast_change(e) {
    var t = document.getElementsByTagName("body")[0], a = document.querySelector(".theme-contrast .btn.active"),
...
function layout_rtl_change(e) {
    var t = document.getElementsByTagName("body")[0], a = document.getElementsByTagName("html")[0],
...
function layout_change(e) {
    ...
    t && t.classList.remove("active"), "dark" === e ? (dark_flag = !0, updateLogo(".pc-sidebar .m-header .logo-lg", "logo.svg"), updateLogo(".navbar-brand .logo-lg", "logo.svg"), updateLogo(".auth-main.v1 .auth-sidefooter img", "logo.svg"), updateLogo(".footer-top .footer-logo", "logo.svg"), updateActiveButton('.theme-layout .btn[data-value="false"]')) : (dark_flag = !1, updateLogo(".pc-sidebar .m-header .logo-lg", "logo.svg"), updateLogo(".navbar-brand .logo-lg", "logo.svg"), updateLogo(".auth-main.v1 .auth-sidefooter img", "logo.svg"), updateLogo(".footer-top .footer-logo", "logo.svg"), updateActiveButton('.theme-layout .btn[data-value="true"]'))
}
...
document.addEventListener("DOMContentLoaded", function () {
    if (document.querySelectorAll(".preset-color")) for (var e = document.querySelectorAll(".preset-color > a"), t = 0; t < e.length; t++) e[t].addEventListener("click", function (e) {
        e = e.target;
