        ...
        <div class="navbar-content mt-5">
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item">
                            <a href="{{ route('livestock.create') }}" class="pc-link" data-i18n="Add Livestock">Add New</a>
                        </li>
                        <li class="pc-item">
                            <a href="{{ route('livestock.index') }}" class="pc-link" data-i18n="View Livestock">View All</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item">
                            <a href="{{ route('health-records.create') }}" class="pc-link" data-i18n="Add Health Record">Add New</a>
                        </li>
                        <li class="pc-item">
                            <a href="{{ route('health-records.index') }}" class="pc-link" data-i18n="View Health Records">View All</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item">
                            <a href="{{ route('vaccinations.create') }}" class="pc-link" data-i18n="Add Vaccination">Add New</a>
                        </li>
                        <li class="pc-item">
                            <a href="{{ route('vaccinations.index') }}" class="pc-link" data-i18n="View Vaccinations">View All</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item">
                            <a href="{{ route('reminders.create') }}" class="pc-link" data-i18n="Add Reminder">Add New</a>
                        </li>
                        <li class="pc-item">
                            <a href="{{ route('reminders.index') }}" class="pc-link" data-i18n="View Reminders">View All</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item">
                            <a href="{{ route('disease-risks.create') }}" class="pc-link" data-i18n="Add Disease Risk">Add New</a>
                        </li>
                        <li class="pc-item">
                            <a href="{{ route('disease-risks.index') }}" class="pc-link" data-i18n="View Disease Risks">View All</a>
                        </li>
                    </ul>
                </li>
